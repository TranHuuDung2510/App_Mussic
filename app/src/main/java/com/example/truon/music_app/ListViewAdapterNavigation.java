...
/**
 * Created by truon on 3/8/2017.
 */

public class ListViewAdapterNavigation extends BaseAdapter {
    String[] result;
    Context context;
    int[] imageId;
     ...
     */
    public ListViewAdapterNavigation(Context context, String[] result, int[] imageId) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.item_navigation, parent, false);

        TextView tvNoiDung = (TextView) rowView.findViewById(R.id.tvNavigation);
        ImageView imgAvatar = (ImageView) rowView.findViewById(R.id.imgNavigation);
