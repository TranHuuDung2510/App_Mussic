...
public class Play_Song extends Activity {
    ...
    ListView listView;
    public static int[] imgAvatar = {R.drawable.nhachot, R.drawable.casi,
            R.drawable.album, R.drawable.video};
    //Nội dung của từng Item trong ListView
    public static String[] tvNoiDung = {"Nhạc Hot", "Ca Sĩ",
            "album", "video"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setAdapter(new ListViewAdapterNavigation(Play_Song.this, tvNoiDung, imgAvatar));
